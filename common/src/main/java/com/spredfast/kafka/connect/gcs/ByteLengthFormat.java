...
import static com.spredfast.kafka.connect.gcs.Constants.HEADER_MARKER;
import static com.spredfast.kafka.connect.gcs.Constants.HEADER_MARKER_SIZE;
import static com.spredfast.kafka.connect.gcs.Constants.LENGTH_FIELD_SIZE;
import static com.spredfast.kafka.connect.gcs.Constants.NO_BYTES;
 ...
 */
public class ByteLengthFormat implements GCSRecordFormat, Configurable {
